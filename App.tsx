    ...
    <>
      ...
      <NavigationContainer>
        <Navigator>
          ...
          <Screen name="Songs" component={SongList} />
          <Screen name="Genres" component={GenreList} />
          <Screen name="Albums" component={AlbumList} />
          <Screen name="Playlists" component={Playlists} />
          <Screen name="Folders" component={FolderList} />
          <Screen name="Artists" component={ArtistList} />
        </Navigator>
      </NavigationContainer>
